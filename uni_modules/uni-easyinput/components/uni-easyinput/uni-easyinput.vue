<template>
  <view class="uni-easyinput" :class="{'uni-easyinput-error':msg}" :style="{color:inputBorder && msg?'#e43d33':styles.color,backgroundColor: backgroundColor,
fontSize: fontSize, width: width}">
    <view class="uni-easyinput__content"
      ...
      <uni-icons v-if="prefixIcon" class="content-clear-icon" :type="prefixIcon" color="#c0c4cc"
        @click="onClickIcon('prefix')" :size="iconSize"></uni-icons>
      <textarea v-if="type === 'textarea'" class="uni-easyinput__content-textarea"
        ...
        :style="{fontSize: fontSize,paddingBottom: maxlength ? '40rpx' : undefined}"
        :placeholderStyle="placeholderStyle" :disabled="disabled" placeholder-class="uni-easyinput__placeholder-class"
        :maxlength="inputMaxlength" :focus="focused" :autoHeight="autoHeight" @input="onInput" @blur="onBlur"
      ...
      <input v-else :type="type === 'password'?'text':type" class="uni-easyinput__content-input" :style="{
				 ...
				 'padding-left':prefixIcon?'':'10px', fontSize: fontSize, height: contentHeight,lineHeight: contentHeight
        ...
        :maxlength="inputMaxlength" :focus="focused" :confirmType="confirmType" @focus="onFocus" @blur="onBlur"
        @input="onInput" @confirm="onConfirm" />
      <template v-if="type === 'password' && passwordIcon">
        <uni-icons v-if="val != '' " class="content-clear-icon" :class="{'is-textarea-icon':type==='textarea'}"
          :type="showPassword?'eye-slash-filled':'eye-filled'" :size="18" color="#c0c4cc" @click="onEyes"></uni-icons>
      </template>
      ...
      <template v-else-if="maxlength">
        <view
          style="font-size: 24rpx;color: #999999;position: absolute;bottom: 5rpx;right: 10rpx;text-align: right;background-color: white;z-index: 999">
          {{ val.length || 0 }}/{{ inputMaxlength }}</view>
      </template>
      <template v-else>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      inputMaxlength() {
        return Number(this.maxlength) || 140;
      },
    },
    watch: {
      value(newVal) {
