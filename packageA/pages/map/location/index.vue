<template>
  <view class="container">
    <map id="maps" class="tui-maps" show-location :longitude="longitude" :latitude="latitude" :scale="16"
      ...
      <cover-image class="tui-cover-back" src="/static/temp/icon_back_3x.png" @tap.stop="back" />
      <cover-image class="tui-cover-image" :class="{ 'tui-ani': ani }" src="/static/temp/icon_marker_3x.png" />
      <cover-image src="/static/temp/icon_location_3x.png" class="tui-current-img" @tap="currentLocation"></cover-image>
    </map>
            ...
            <view class="tui-list__item">
              <view class="tui-addr-box">
                ...
                <view class="tui-addr-detail">
                  <text class="tui-distance">{{getDistance(item.distance,item._distance) }}</text>
    ...
    <view class="tui-btn__box">
      <tui-button disabledGray :disabled="index == -1" height="72rpx" shape="circle" :size="30" @click="btnFix">确定
      </tui-button>
      <view class="tui-seize__seat"></view>
    </view>
  </view>
...
<script>
  ...
  import QQMapWX from '@/js_mdules/wx-qqmap/qqmap-wx-jssdk.min.js'
  export default {
    data() {
      return {
        ani: true,
        ...
        latitude: 22.63137,
        key: 'NJEBZ-X6MWW-Y56RH-3ZTXH-WKBOT-OUBJ2',
        qqmapsdk: null,
        scrollH: 0,
        address: [],
        timer: null,
