  ...
  <view>
    <view class="tui-form-container">
      <view class="userinfo-detail">
        <tui-form-item asterisk label="头像" :padding="itemPadding" :left="itemLeft">
        ...
        <tui-form-item asterisk label="昵称" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.fullName" :disabled="true" class="input-view-value" placeholder="请输入"
              @input="form.fullName = $event.detail.value" />
          </template>
        </tui-form-item>
        <tui-form-item asterisk label="性别" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
        ...
        <tui-form-item asterisk label="姓名" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.fullName" :disabled="true" class="input-view-value" placeholder="请输入"
              @input="form.fullName = $event.detail.value" />
          </template>
        </tui-form-item>
        <tui-form-item asterisk label="手机号" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.mobile" class="input-view-value" placeholder="请输入"
              @input="form.mobile = $event.detail.value" />
          </template>
        </tui-form-item>
        <tui-form-item asterisk label="身份证号" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
        ...
        <tui-form-item asterisk direction="column" label="身份证照片上传" :padding="itemPadding" :left="itemLeft"
        ...
        <tui-form-item asterisk label="邮箱" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.idCard" class="input-view-value" placeholder="请输入"
              @input="form.idCard = $event.detail.value" />
          </template>
        ...
        <tui-form-item asterisk label="通讯地址" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.idCard" class="input-view-value" placeholder="请输入"
              @input="form.idCard = $event.detail.value" />
          </template>
        ...
        <tui-form-item asterisk label="紧急联系人" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.idCard" class="input-view-value" placeholder="请输入"
              @input="form.idCard = $event.detail.value" />
          </template>
        ...
        <tui-form-item asterisk label="工作组别/角色" :padding="itemPadding" :left="itemLeft">
          <template v-slot:right>
            <input :value="form.idCard" class="input-view-value" placeholder="请输入"
              @input="form.idCard = $event.detail.value" />
          </template>
        ...
        <tui-form-item direction="column" label="教育经历" padding="26rpx 0" :left="0" content-margin-top="8px">
          <tui-textarea isCounter autoHeight v-model="form.content" textarea-border maxlength="500"
            placeholder="教育经历" />
        </tui-form-item>

        <tui-form-item direction="column" label="工作经历" padding="26rpx 0" :left="0" content-margin-top="8px">
          <tui-textarea isCounter autoHeight v-model="form.content" textarea-border maxlength="500"
            placeholder="工作经历" />
        </tui-form-item>

        <tui-form-item direction="column" label="我的作品" padding="26rpx 0" :left="0" content-margin-top="8px">
          <tui-textarea isCounter autoHeight v-model="form.content" textarea-border maxlength="500"
            placeholder="我的作品" />
        </tui-form-item>

        <tui-form-item direction="column" label="我的成就" padding="26rpx 0" :left="0" content-margin-top="8px">
          <tui-textarea isCounter autoHeight v-model="form.content" textarea-border maxlength="500"
            placeholder="我的成就" />
        </tui-form-item>

        <tui-form-item direction="column" label="自我评价" padding="26rpx 0" :left="0" content-margin-top="8px">
          <tui-textarea isCounter autoHeight v-model="form.content" textarea-border maxlength="500"
            placeholder="自我评价" />
        </tui-form-item>
      </view>
